        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-stiped">
                    <thead>
                        <tr class="text-center" style="background-color: rgb(111, 0, 255)">
                        <th>No</th>
                        <th>Nama</th>
                        <th>Telepon</th>
                        <th>Alamat</th>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="/perusahaan/edit/{{ $item->id_perusahaan }}" class="btn btn-success">
                                    ...
                                    edit</a>
                                <a href="/perusahaan/delete/{{ $item->id_perusahaan }}" class="btn btn-danger" onclick="return window.confirm('hapus data ini')">
